...
% Group 1 - I A
  \node[name=H, Nonmetal] {\NaturalElementTextFormat{1}{1.0079}{\gas{H}}{\gas{Hydrogen}}};
...
% Legend - Element Families
  \draw[black, AlkaliMetalFill] ($(La.north -| Fr.west) + (1em,-0.0em)$)
    rectangle +(1em, 1em) node[right, yshift=-1ex]{\LARGE Alkali Metals};
  \draw[black, AlkalineEarthMetalFill] ($(La.north -| Fr.west) + (1em,-2em)$)
    rectangle +(1em, 1em) node[right, yshift=-1ex]{\LARGE Alkaline Earth Metals};
  \draw[black, MetalFill] ($(La.north -| Fr.west) + (1em,-4em)$)
    rectangle +(1em, 1em) node[right, yshift=-1ex]{\LARGE Transition Metals};
  \draw[black, PosttransitionmetalFill] ($(La.north -| Fr.west) + (1em,-6em)$)
    rectangle +(1em, 1em) node[right, yshift=-1ex]{\LARGE Poor Metals};
  \draw[black, MetalloidFill] ($(La.north -| Fr.west) + (1em,-8em)$)
    rectangle +(1em, 1em) node[right, yshift=-1ex]{\LARGE Metalloids};
  \draw[black, NonmetalFill] ($(La.north -| Fr.west) + (1em,-10em)$)
    rectangle +(1em, 1em) node[right, yshift=-1ex]{\LARGE Non-Metals};
  \draw[black, HalogenFill] ($(La.north -| Fr.west) + (1em,-12em)$)
    rectangle +(1em, 1em) node[right, yshift=-1ex]{\LARGE Halogens};
  \draw[black, NobleGasFill] ($(La.north -| Fr.west) + (1em,-14em)$)
    rectangle +(1em, 1em) node[right, yshift=-1ex]{\LARGE Noble Gases};
  ...
  \draw[black, UnknownFill] ($(La.north -| Fr.west) + (1em,-20em)$)
    rectangle +(1em, 1em) node[right, yshift=-1ex]{\LARGE Unclassified};

% Legend - Description
  \node[Posttransitionmetal] at (8,-2.5) {\NaturalElementTextFormat{13}{\num{26.982}}{Al}{Aluminium}};
  \draw [<-, > = stealth] (7,-1) -- (7,-0.7) -- (10.5,-0.7) node[right] {\LARGE Atomic Number};
  \draw [<-, > = stealth] (9.5,-2.5) -- (10.5,-2.5) node[right] {\LARGE Symbol};
  \draw [<-, > = stealth] (9.5,-1.65) -- (10.5,-1.65) node[right] {\LARGE Relative Atomic Mass};
  \draw [<-, > = stealth] (9.5,-3.35) -- (10.5,-3.35) node[right] {\LARGE Name};
  \draw (6.5,-4.7) node[right] {\LARGE (\sld{solid}, \liq{liquid}, \gas{gas} at \SI{0}{\degreeCelsius} and \SI{1}{atm})};

\node[AlkalineEarthMetal] at (22,-2.5) {\FromDecayElementTextFormat{88}{\num{226}}{Ra}{Radium}};
  \draw [<-, > = stealth] (22,-1) -- (22,-0.7) -- (23,-0.7) node[right] {\LARGE Decay Product};
\node[Actinide] at (27,-2.5) {\SyntheticElementTextFormat{95}{\num{243}}{Am}{Américium}};
  \draw [<-, > = stealth] (27,-4) -- (27,-4.3) -- (26,-4.3) node[left] {\LARGE Synthetic Element};
